...
def index():
	...
	regressing = LinearRegression().fit([77.09,77.09,77.09,77.09,84.26,84.26,84.26,84.26,84.26,90.44],[38273,35242,34382,33432,27433,28187,27552,26379,26224,30236])
	#regressing.fit(X,y)
